...
var _user$project$Main$trackView = function (track) {
	var artist = function () {
		var _p0 = _elm_lang$core$List$head(track.artists);
		if (_p0.ctor === 'Just') {
			return _p0._0;
		} else {
			return 'Unknown';
	...
	var imageUrl = function () {
		var _p1 = _elm_lang$core$List$head(track.album.images);
		if (_p1.ctor === 'Just') {
			return _p1._0;
		} else {
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('image is-128x128'),
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('subtitle is-6')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
...
var _user$project$Main$spotifyView = function (model) {
	var _p2 = model.tracks;
	switch (_p2.ctor) {
		case 'NotAsked':
			return A2(
				_elm_lang$html$Html$div,
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Search for tracks!')
					]));
		case 'Loading':
			return A2(
				_elm_lang$html$Html$div,
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							'Searching for ',
							A2(_elm_lang$core$Basics_ops['++'], model.query, '...')))
					]));
		case 'Failure':
			return A2(
				_elm_lang$html$Html$div,
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('There was an error...')
					]));
		default:
			var _p3 = _p2._0;
			if (_elm_lang$core$Native_Utils.eq(
				...
				var trackViews = _elm_lang$core$Array$fromList(
					A2(_elm_lang$core$List$map, _user$project$Main$trackView, _p3));
				return A2(
					_elm_lang$html$Html$div,
					_elm_lang$core$Native_List.fromArray(
						[]),
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Array$toList(
								A3(_elm_lang$core$Array$slice, 0, 5, trackViews))),
							A2(
							_elm_lang$html$Html$div,
							_elm_lang$core$Native_List.fromArray(
								[
							...
							_elm_lang$core$Array$toList(
								A3(_elm_lang$core$Array$slice, 5, 10, trackViews))),
							A2(
							_elm_lang$html$Html$div,
							_elm_lang$core$Native_List.fromArray(
								[
							...
							_elm_lang$core$Array$toList(
								A3(_elm_lang$core$Array$slice, 10, 15, trackViews))),
							A2(
							_elm_lang$html$Html$div,
							_elm_lang$core$Native_List.fromArray(
								[
							...
							_elm_lang$core$Array$toList(
								A3(_elm_lang$core$Array$slice, 15, 20, trackViews)))
						]));
			}
	}
};
var _user$project$Main$SpotifyAlbum = F2(
	function (a, b) {
		return {name: a, images: b};
	});
var _user$project$Main$SpotifyTrack = F3(
	function (a, b, c) {
		return {album: a, artists: b, name: c};
	});
var _user$project$Main$decodeSpotifyJson = A2(
	_elm_lang$core$Json_Decode$at,
	_elm_lang$core$Native_List.fromArray(
		['tracks', 'items']),
	_elm_lang$core$Json_Decode$list(
		A4(
			...
			_user$project$Main$SpotifyTrack,
			A2(
				_elm_lang$core$Json_Decode_ops[':='],
				'album',
				A3(
					_elm_lang$core$Json_Decode$object2,
					_user$project$Main$SpotifyAlbum,
...
var _user$project$Main$init = {
	ctor: '_Tuple2',
	_0: {query: '', tracks: _user$project$Main$NotAsked},
	_1: _elm_lang$core$Platform_Cmd$none
};
var _user$project$Main$SearchResult = function (a) {
	return {ctor: 'SearchResult', _0: a};
};
var _user$project$Main$fetchSpotify = function (query) {
	var url = A2(
		_elm_lang$core$Basics_ops['++'],
	...
	return A2(
		...
		A3(
			...
			A2(_evancz$elm_http$Http$get, _user$project$Main$decodeSpotifyJson, url)));
};
		...
		switch (_p4.ctor) {
			...
			case 'Search':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{tracks: _user$project$Main$Loading}),
					_1: _user$project$Main$fetchSpotify(model.query)
				};
			default:
				return {
					ctor: '_Tuple2',
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Spotify Search')
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('input column is-4'),
								_elm_lang$html$Html_Attributes$placeholder('Search track title'),
								_elm_lang$html$Html_Events$onInput(_user$project$Main$UpdateQuery)
							]),
						_elm_lang$core$Native_List.fromArray(
							[])),
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$html$Html_Events$onClick(_user$project$Main$Search)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
				...
				_user$project$Main$spotifyView(model)
			]));
};
